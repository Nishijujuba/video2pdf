...
| [Video Workflow](./docs/contexts/video-workflow/CONTEXT.md) | active | Run lifecycle, source preparation, production, assurance, repair, compile provenance, Final Compile Input Sets, Final Editable TeX Source Sets, Final Delivery Packages, resources, Batch projections, and delivery mechanics | Pyramid semantic judgment, Final Acceptance semantic judgment, and historical-directory relocation |
...
| Video Workflow → Final Acceptance | `Final Evidence Checkpoint`, `Final Editable TeX Source Set`, `Allowed Artifact Manifest`, `Render Evidence Manifest`, and workflow-owned `Judgment Patch` mechanics | Video Workflow owns compile-evidence source discovery, evidence production, and task mechanics; Final Acceptance consumes the source-set projection and controls what evidence may support its semantic decision. |
