...
Status: active_global_gate. It succeeded the Final Acceptance Context at the Global Gate Cutover. The Workflow Release Profile now owns ordinary admission for Bilibili and YouTube `active_kernel` tasks and `active_batch` Batch work. Existing directories remain on explicit Legacy maintenance routes. This context continues to own Acceptance Report v2, every-page visual review, Delivery Guard, and delivery-quality authority for both execution tracks.
