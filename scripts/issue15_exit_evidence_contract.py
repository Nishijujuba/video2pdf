...
RESULT_SPECS = (
    (
        ...
        "positive",
        "tests.video_workflow.test_issue15_batch_projection.test_batch_record_contract_pass",
        None,
        None,
    ),
    (
        ...
        "positive",
        "tests.video_workflow.test_issue15_batch_projection.test_projection_rebuild_pass",
        None,
        None,
    ),
    (
        ...
        "positive",
        "tests.video_workflow.test_issue15_batch_authority.test_guarded_delivered_only_success",
        None,
        None,
    ),
    (
        ...
        "negative",
        "tests.video_workflow.test_issue15_batch_authority.test_duplicate_run_rejected",
        "batch_authority",
        "duplicate_run_rejected",
    ),
    (
        ...
        "negative",
        "tests.video_workflow.test_issue15_batch_authority.test_pdf_existence_success_rejected",
        "batch_authority",
        "pdf_existence_success_rejected",
    ),
    (
        ...
        "negative",
        "tests.video_workflow.test_issue15_batch_authority.test_per_video_mutation_rejected",
        "batch_authority",
        "per_video_mutation_rejected",
    ),
    (
        ...
        "recovery",
        "tests.video_workflow.test_issue15_batch_projection.test_reconcile_interrupted_item_creation",
        None,
        None,
    ),
    (
        ...
        "fencing",
        "tests.video_workflow.test_issue15_batch_projection.test_projection_revision_fencing",
        None,
        None,
    ),
    (
