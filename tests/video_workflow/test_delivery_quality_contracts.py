...
class DeliveryQualityContractsCliTests(unittest.TestCase):
    def test_public_contract_check_proves_closed_target_only_policy_surface(
        ...
        self.assertEqual(envelope["data"]["contract_count"], 21)
        self.assertEqual(envelope["data"]["positive_examples_validated"], 21)
        self.assertEqual(envelope["data"]["negative_examples_rejected"], 21)
